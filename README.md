...
![首页与素材导入](docs/assets/preview/01-home-upload.png)

### 创作工作台

![创作工作台](docs/assets/preview/02-workspace.png)

### 登录与账号入口

![登录与账号入口](docs/assets/preview/03-login.png)

### AI 总结与场景拆解

![AI 总结与场景拆解](docs/assets/preview/04-ai-summary.png)
